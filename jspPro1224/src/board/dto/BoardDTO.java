...
public class BoardDTO {
	...
	public String toString() {
		return "BoardDTO [num=" + num + ", writer=" + writer + ", username=" + username + ", passwd=" + passwd
				+ ", reg_date=" + reg_date + ", readcount=" + readcount + ", ref=" + ref + ", re_step=" + re_step
				+ ", re_level=" + re_level + ", job=" + job + ", ip=" + ip + ", comment_count=" + comment_count
